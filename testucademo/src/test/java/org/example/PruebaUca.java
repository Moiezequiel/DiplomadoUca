...
public class PruebaUca {
    ...
    public void agregarCarrito(){
        WebElement btnAgregarI, btnAgregarII;
        btnAgregarI = driver.findElement(By.cssSelector("#add-to-cart-sauce-labs-backpack"));
        btnAgregarI.click();
        btnAgregarII = driver.findElement(By.cssSelector("#add-to-cart-sauce-labs-bike-light"));
        btnAgregarII.click();
